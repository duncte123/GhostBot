    ...
    public void loadAndPlay(GuildMusicManager mng, final TextChannel channel, final String trackUrlRaw, final boolean addPlayList) {
        ...
        playerManager.loadItemOrdered(mng, trackUrl, new AudioLoadResultHandler() {
            ...
            public void playlistLoaded(AudioPlaylist playlist) {
                ...
                if (tracks.size() == 0) {
                    MessageUtils_java.sendEmbed(channel, EmbedUtils_java.embedField(embedTitle, "Error: This playlist is empty."));
                    return;
                ...
                MessageUtils_java.sendEmbed(channel, EmbedUtils_java.embedField(embedTitle, msg));
            }


            @Override
            public void noMatches() {
                MessageUtils_java.sendEmbed(channel, EmbedUtils_java.embedField(embedTitle, "Nothing found by _" + trackUrl + "_"));
            }

            @Override
            public void loadFailed(FriendlyException exception) {
                MessageUtils_java.sendEmbed(channel, EmbedUtils_java.embedField(embedTitle, "Could not play: " + exception.getMessage()
