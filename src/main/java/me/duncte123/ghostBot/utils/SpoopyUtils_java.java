...
public class SpoopyUtils_java {
    public static final AudioUtils_java audio = AudioUtils_java.ins;
    public static final Config config = new ConfigUtils_java().loadConfig();
    public static final Config IMAGES = new ConfigUtils_java().loadImages();
    public static final Random random = new Random();

    public static final WikiHolder_java WIKI_HOLDER = new WikiHolder_java("https://dannyphantom.wikia.com");

    public static final CommandManager_java commandManager = new CommandManager_java();
