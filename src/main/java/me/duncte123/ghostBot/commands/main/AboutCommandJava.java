...
public class AboutCommandJava extends Command_java {
    @Override
    public void execute(String invoke, String[] args, GuildMessageReceivedEvent event) {
        sendEmbed(event, EmbedUtils_java.embedMessage("Hey there I'm GhostBot, I'm here for all your <:DPEmblemInvertStroke:422022982450282496> Danny Phantom needs.\n" +
