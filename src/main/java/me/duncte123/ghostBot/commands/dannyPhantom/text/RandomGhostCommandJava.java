...
public class RandomGhostCommandJava extends Command_java {
    ...
    public void execute(String invoke, String[] args, GuildMessageReceivedEvent event) {
        String ghost = ghosts.get(SpoopyUtils_java.random.nextInt(ghosts.size()));
        MessageUtils_java.sendMsg(event, ghost);
    }
