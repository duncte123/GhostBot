...
public class GhostBot_java {

    private static final Logger logger = LoggerFactory.getLogger(GhostBot_java.class);

    private static final GhostBot_java ins = new GhostBot_java();
    ...
    public static void main(String[] args) {
        ...
        String token = SpoopyUtils_java.config.getString("discord.token");
        LavalinkManager.ins.start();
        try {
            JDABuilder builder = new JDABuilder(AccountType.BOT)
                    .setAudioEnabled(true)
                    .setGame(Game.playing(Variables_java.PREFIX + "help | Going Ghost"))
                    .setToken(token)
                    .addEventListener(new BotListener_java());
    ...
    public static GhostBot_java getInstance() {
        return ins;
    }
